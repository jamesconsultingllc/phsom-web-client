...
export class NavbarComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        const openIdConnectService = this.openIdConnectService;
        this.openIdConnectService.userLoaded$.subscribe((userLoaded) => {
            if(userLoaded) {
                this.loggedInUser =  `${openIdConnectService.user.profile.given_name} ${openIdConnectService.user.profile.family_name}`;
            }
        })
    }
